import { LogicBase } from '@/internal/logic';
import { ecdh192 } from '@/internal/util/crypto/ecdh';
...
export class WtLoginLogic extends LogicBase {
    buildWtLoginPacket(cmd: WtLoginCommandType, data: Buffer) {
        const encrypted = encryptTea(data, ecdh192.shareKey);
        ...
        const body = new SmartBuffer()
            ...
            .writeUInt16BE(ecdh192.publicKey.length)
            .writeBuffer(ecdh192.publicKey)
